    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-[999] pointer-events-auto">
        <motion.button
          ...
          className="w-14 h-14 liquid-glass-dark liquid-glass-rim text-gold-light rounded-full flex items-center justify-center cursor-pointer relative focus:outline-none"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 left-4 right-4 md:left-auto md:right-6 md:w-[380px] h-[500px] max-h-[calc(100vh-120px)] liquid-glass liquid-glass-rim rounded-2xl z-[998] flex flex-col overflow-hidden pointer-events-auto"
          >
            {/* Header */}
            <div className="bg-forest/85 px-4 py-3 flex items-center justify-between border-b border-gold/20">
            ...
            {/* Messages Body */}
            <div className="flex-grow overflow-y-auto p-4 flex flex-col gap-3 scrollbar-hide bg-parchment/20">
                  ...
                  <div
                    className={`p-3 rounded-2xl text-xs leading-relaxed whitespace-pre-line ${
                      msg.sender === 'user'
                        ...
                        : 'bg-warm/85 text-ink border border-gold/15 rounded-tl-none'
                    }`}
                  >
                    {msg.text}
              ...
              {isTyping && (
                <div className="self-start flex flex-col max-w-[85%]">
                  <div className="p-3 bg-warm/85 text-ink border border-gold/15 rounded-2xl rounded-tl-none flex items-center gap-1">
            ...
            <div className="px-4 py-2 bg-warm/40 border-t border-gold/10 flex gap-2 overflow-x-auto scrollbar-hide shrink-0">
            ...
            {/* Input Footer */}
            <div className="p-3 bg-warm/40 border-t border-gold/15 flex items-center gap-2 shrink-0">
              <input
                type="text"
                value={inputValue}
                ...
                className="flex-grow border border-gold/25 bg-white/70 p-2.5 text-xs text-ink outline-none focus:border-forest rounded-lg w-full transition-colors"
              />
              <button
