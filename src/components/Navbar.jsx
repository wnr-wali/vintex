    ...
    <>
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-16 transition-all duration-500 ease-out ${scrolled
          ? 'liquid-glass py-0 border-b border-gold/15'
        ...
        {menuOpen && (
          <>
            ...
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="fixed top-0 left-0 right-0 z-[58] md:hidden liquid-glass liquid-glass-rim overflow-y-auto rounded-b-3xl"
              role="dialog"
              aria-modal="true"
