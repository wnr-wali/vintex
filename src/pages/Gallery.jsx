      ...
      <AnimatePresence>
        {activeIndex !== null && (
          <motion.div
            ...
            className="fixed inset-0 z-[1000] bg-ink/95 flex flex-col justify-center items-center p-4 md:p-8 backdrop-blur-sm"
            onClick={closeLightbox}
          >
            <button
              className="absolute top-4 right-4 md:top-6 md:right-6 text-white/70 hover:text-white transition-colors cursor-pointer z-10 bg-transparent border-none"
              onClick={closeLightbox}
              aria-label="Close"
            >
            ...
            <button
              className="absolute left-2 md:left-6 top-1/2 -translate-y-1/2 text-white/70 hover:text-white p-2 transition-colors cursor-pointer z-10 bg-transparent border-none"
              onClick={prevImage}
              aria-label="Previous"
            >
            ...
            <button
              className="absolute right-2 md:right-6 top-1/2 -translate-y-1/2 text-white/70 hover:text-white p-2 transition-colors cursor-pointer z-10 bg-transparent border-none"
              onClick={nextImage}
              aria-label="Next"
            >
            ...
            >
              ...
              />
              <p className="text-white/80 font-serif text-base md:text-lg mt-4 tracking-wide text-center">
